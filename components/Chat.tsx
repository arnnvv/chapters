...
export function Chat({
  ...
  const handleContentSubmit = async (text: string, background: string) => {
    ...
    try {
      ...
      const message =
        err instanceof Error ? err.message : "Unknown error generating index.";
  ...
  return (
    <div className="flex h-screen bg-background text-foreground relative">
      ...
      <div className="flex-grow flex flex-col p-4 md:p-6 lg:p-8 overflow-y-auto pl-16 md:pl-20 lg:pl-24 relative">
        ...
        {!isContentSubmitted && (
          <ContentInput onSubmit={handleContentSubmit} isLoading={isIndexing} />
        )}
        ...
        {isIndexing && (
          <p className="mt-4">Generating index and loading first chapter...</p>
        )}
