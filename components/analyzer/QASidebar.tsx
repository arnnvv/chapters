                ...
                <div className="flex justify-start">
                  <div className="bg-muted p-3 rounded-lg max-w-[80%]">
                    ...
                    {isLoading &&
                      ...
                      // --- MODIFIED LINE: Apply same prose classes as ChapterDisplay ---
                      <div className="prose sm:prose-lg lg:prose-xl dark:prose-invert max-w-none markdown-content text-foreground">
                        <ReactMarkdown
                          ...
                          components={{
                            ...
                            code({ node, className, children, ...props }) {
                              ...
                              if (isBlock) {
                                return (
                                  <div className="my-2 rounded-md overflow-hidden bg-muted/50 dark:bg-secondary text-foreground">
                                    <pre
                                      className={cn(
                                        "p-3 overflow-x-auto text-xs", // Adjusted text size for code blocks in QA
                                        className,
                                      )}
                                    >
                                      <code>{children}</code>
                              ...
                              return (
                                <code
                                  className={cn(
                                    "bg-muted/50 px-1 py-0.5 rounded text-xs font-mono", // Adjusted text size for inline code in QA
                                    className,
                                  )}
                                >
                                  {children}
