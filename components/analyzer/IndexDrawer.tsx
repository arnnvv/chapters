  ...
  return (
    <Sheet>
      <SheetTrigger asChild>
        <Button variant="outline" size="icon" className="absolute top-4 left-4 md:top-6 md:left-6 lg:top-8 lg:left-8 z-10" aria-label="Open chapter index">
        ...
        <div className="flex-grow overflow-y-auto py-4">
          {index.map((item) => (
            <SheetClose asChild key={item.chapter}>
              ...
              >
                <span className="font-mono text-xs w-8 text-muted-foreground mr-2">{item.chapter}.</span>
